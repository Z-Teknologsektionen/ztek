...
//     label: "Namn på arrangören",
//     placeholder: "Namn på arrangören",
//     defaultValue: "",
//     validation: z.string().min(2, {
...
//     placeholder: "Email till arrangören",
//     defaultValue: "",
...
//     placeholder: "Telefonnummer till arrangören",
//     defaultValue: "",
//     validation: z.string().min(2, {
...
//   {
//     dbName: "inChargeName",
//     label: "Namn på festansvarig",
//     placeholder: "Namn på festansvarig",
//     defaultValue: "",
//     validation: z.string().min(2, {
...
//     placeholder: "Email till festansvarig",
//     defaultValue: "",
//     validation: z.string().email({
//       message: "Du måste specificera en giltig email.",
//     }),
...
//     placeholder: "Telefonnummer till festansvarig",
//     defaultValue: "",
//     validation: z.string().min(2, {
//       message: "Du måste specificera ett telefonnummer.",
//     }),
...
//     label: "Primärt datum för eventet",
//     placeholder: "Primärt datum för eventet",
//     defaultValue: new Date(),
//     validation: z.date().min(new Date(), {
...
//     label: "Sekundärt datum för eventet",
//     placeholder: "Sekundärt datum för eventet",
//     defaultValue: new Date(),
//     validation: z.date().min(new Date(), {
//       message: "Du kan inte boka en dag som redan har varit.",
//     }),
...
//   },
//   {
//     dbName: "hasServingPermit",
//     label: "Har du serveringstillstånd?",
//     placeholder: "Har du serveringstillstånd?",
//     defaultValue: false,
...
//   string,
//   string | ZodString | ZodDate | ZodDefault<ZodBoolean>
// > = {};

// formFields.forEach((field) => {
//   validationSchema[field.dbName] = field.validation;
// });

// const defaultValues: Record<string, string | boolean | Date> = {};
// formFields.forEach((field) => {
//   defaultValues[field.dbName] = field.validation.default;
// });

// const formSchema = z.object(validationSchema as z.ZodRawShape);
