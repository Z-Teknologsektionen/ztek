      ...
      <div className="grid grid-cols-5 gap-x-20">
        <div className="col-span-full lg:col-span-3">
          <p className="max-w-3xl">
            Zaloonen är Z-sektionens sektionslokal och är belägen på bottenplan
            i HB. Som Z-teknolog finns det möjlighet att hålla arrangemang i
            Zaloonen. Inför arrangemang i Zaloonen kommer ZÅG ta ut en
            städdeposition som återfås vid godkänd avsyning. Avsyning sker
            alltid kl 07:30 på vardagar och 11:30 på helger, om ni inte har
            någon annan överenskommelse med ZÅG.
            <br />
            <br />
