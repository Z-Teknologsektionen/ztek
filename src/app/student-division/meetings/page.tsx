  ...
  return (
    <main className="mx-auto max-w-3xl p-6">
      ...
      <p className="text-base leading-7 text-gray-700 py-2">
        ...
        <p className="text-base leading-7 text-gray-700 py-2">
        På sektionsmöten bjuds även pizza och fika så kom jättegärna och påverka sektionens framtid.
        För dig som är ny student kommer även en testmöte hållas under mottagningen där du får lära dig hur ett sektionsmöte går till!
        </p>
        <h3 className="mt-6 mb-2 text-lg font-semibold">Håll utkick på datum i kårappen!!</h3>
    </main>
  );
}
