  ...
  return (
    <SectionWrapper>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="order-last col-span-3 lg:order-last lg:col-span-2">
          <p>
        ...
        <Image src="" alt="Instruktioner för kalenderprenumeration" />
      </div>

      <div className="grid grid-cols-3 gap-4">
        <div className="order-last col-span-3 lg:order-first lg:col-span-2">
          <p>
