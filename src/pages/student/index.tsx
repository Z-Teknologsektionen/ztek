            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="col-span-1 my-4 flex flex-col rounded-md">
                <div className="pb-4">
                  ...
                  <p className="mx-4">
                    ...
                    isåfall för att läsa mer om programmet och vad du kan
                    förvänta dig!
                  </p>
                </div>
                <Button
              ...
              <div className="col-span-1 my-4 flex flex-col rounded-md">
                <div className="pb-4">
                  ...
                  <p className="mx-4">
                    Vill du vara med och påverka dina studier? Klicka här för
                    att få mer information om vad Zätas studienämnd kan hjälpa
                    dig med.
                  </p>
                </div>
                <Button
        ...
        SNZ-bös */}
            ...
            <div className="grid grid-cols-3">
              <div className="col-span-3 md:col-span-2 md:pr-20">
                ...
                <p>
                  ...
                  möjligheter att få hjälp och möjlighet att påverka dina
                  studier. Här nedanför finns lite information om vad som finns
                  tillgängligt för dig som student och information om
                  programmet. Programmets studieplan hittar du på{" "}
                  <Link
                  ...
                  varje år. Som student på Z-programmet har man stor möjlighet
                  att välja olika mastrar beroende på intresseområde då över 20
                  olika masterprogram är valbara för Z-studenter. Alla
                  masterprogram och dess specifika förkunskapskrav hittar du på
                  samma sida som programplanen.
                </p>
              </div>
          ...
          <SectionWrapper id="snz">
            <div className="grid grid-cols-3">
              ...
              <div className="order-first col-span-3 pl-4 lg:order-last lg:col-span-2">
                ...
                <p>
                  Automation och Mekatronik har en dedikerad Studienämnd som
                  heter SNZ och inriktar sig på att främja en högkvalitativ och
                  givande utbildning inom sektionens programplan. SNZ har en
                  central roll i sektionens verksamhet och utbildningsarbete.
                  <br />
                  <br />
                  ...
                  säkerställa att studenterna får den bästa möjliga
                  utbildningen. Feedback från studenter är oerhört viktig för
                  dem, och de arbetar aktivt med att ta emot och behandla detta
                  för att ständigt förbättra utbildningen.
                  <br />
                  <br />
                  SNZ består av medlemmar från sektionen och möts regelbundet
                  för att diskutera och påverka utbildningsfrågor genom möten
                  med programansvariga och föreläsare. På SNZ:s hemsida kan du
                  få mer information om kommitténs arbete, deras medlemmar och
                  deras pågående projekt och initiativ inom sektionen. Om du har
                  frågor eller feedback gällande utbildning inom programmet kan
                  du kontakta SNZ via deras hemsida.
                </p>
          ...
          <SectionWrapper>
            ...
            <p>
              ...
              studievägledare och utbildningssekreterare. Programledningen
              jobbar med att säkra framtida kompetens inom Z-programmet och
              övervaka den nuvarande studieplanen. De arbetar också med att
              utveckla och förbättra programmet genom att ta emot och behandla
              feedback från de studenter som går på programmet.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
              {isLoading && (
                <p>Försöker hämta programledningens medlemmar...</p>
              )}
