          ...
          <div className="grid grid-cols-3 py-8">
            <div className="col-span-3 md:col-span-2 md:pl-20">
              ...
              <p>
                ...
                underlätta dina studier. Dessa stöd inkluderar bland annat extra
                tid på tentor, anteckningsstöd, tekniska hjälpmedel och
                anpassade studiematerial. För att få tillgång till detta stöd
                behöver du ett intyg som styrker din funktionsnedsättning. Du
                kan läsa mer om detta på Chalmers hemsida.
              </p>
              <ul className="mt-6">
                <li className="mb-2 flex items-center justify-center md:justify-start">
                  <MdEmail className="mr-2" />
