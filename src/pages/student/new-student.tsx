        ...
        <div className="container mx-auto divide-y-4 divide-zDarkGray divide-opacity-20">
          <SectionWrapper>
            <div className="grid grid-cols-3">
              ...
              <div className="order-first col-span-3 pl-4 lg:order-last lg:col-span-2">
                ...
                <p>
                  ...
                  sammanföra dessa tre discipliner skapas en utbildningsmiljö
                  där studenter får en bred kunskapsbas och en djup förståelse
                  för teknikens olika aspekter. Inom automation och mekatronik
                  får studenter möjlighet att utforska och integrera avancerade
                  teknologier inom elektronik, maskinkonstruktion och
                  dataprogrammering. Genom att lära sig att designa och
                  implementera smarta och effektiva system kan de möta
                ...
                <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                  <div className="border-gradient rounded-lg">
                    ...
                    <p>
                      Elektroteknikens kunskaper ger studenterna en
                      grundläggande förståelse för elektroniska kretsar,
                      mätningar och styrningssystem. Detta ger en bra grund
                      inför kommande kurser inom reglerteknik.
                    </p>
                  </div>
                  <div className="border-gradient rounded-lg">
            ...
            <p>
              ...
              projekt och laborationer, samarbeta med forskare och experter inom
              området och utforska den senaste tekniken inom automation och
              mekatronik. Studenter vid Z-programmet kan välja på 21 olika
            ...
            <div className="grid grid-cols-3">
              <div className="order-first col-span-3 pl-4 lg:order-last lg:col-span-2">
                ...
                <p className="mr-0 md:mr-12">
                  ...
                  veckor av engagerande aktiviteter. Genom varierande
                  aktiviteter får du möjlighet att lära känna dina medstudenter
                  på sektionen. Det viktigaste är att du närmar dig denna period
                  med en positiv inställning och är redo att njuta av varje
                  stund! Det är normalt att känna nervositet inför mottagningen,
                  men kom ihåg att du inte är ensam. Mottagningskommiten och
                  deras phaddrar kommer göra sitt bästa för att se till att din
                  mottagning blir fantastisk, men det är du som formar din egen
          ...
          <SectionWrapper>
            ...
            <p className="text-left">
              På Chalmers inleds civilingenjörsprogrammen med tre år av
              varierande studier som bygger upp en gedigen teknisk kompetens.
              Första året på Automation & Mekatronik fokuserar på grundläggande
              ämnen som matematik, programmering och fysik. Under det andra året
              introduceras kärnkurser inom automation, reglerteknik och
              elektronik. Det tredje året markerar en fördjupning genom
              avancerade kurser inom mekatronik, realtidsystem och
              instrumentering. Under detta år får studenten välja kurser som
              passar deras intressen, och under våren genomförs kandidatarbete.
              Efter dessa tre år väljer studenterna ett masterprogram för
              ytterligare specialisering och fördjupning inom sitt valda område.
              Denna strukturerade progression ger studenterna möjlighet att
              successivt specialisera sig och skapar en stark teknisk grund för
              framtida studier och en karriär inom automations- och
              mekatroniksektorn. Nedan följer en översikt över de kurser som
              ingår under de tre första åren, tryck på en kurs för att läsa mer
            </p>
            {/* Getting courseData from src/data/courseData.*/}
            <div className="grid grid-cols-1 gap-4 bg-white lg:grid-cols-3">
              <TooltipProvider>
                {Object.entries(courseData).map(
                  ([year, periods], yearIndex) => (
